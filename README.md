...
<p>
  ...
  <div>
    <img src="./public/screenshots/myTango_m_main.jpg" alt="모바일 뷰" width=30% />
    <img src="./public/screenshots/myTango_m_words.jpg" alt="단어목록" width=30% />
    <img src="./public/screenshots/myTango_m_note.jpg" alt="단어장" width=30% />
  </div>
</p>
...
3. 히라가나/가타카나 퀴즈 추가하기
4. 퀴즈의 선택지의 퀄리티를 높이기 위해 embedding기반으로 점수를 측정하게 변경하기
5. 어플로 마이그레이션하기
