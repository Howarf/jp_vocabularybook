...
// 공개 인증 페이지 접근 전 Supabase 인증 세션을 확인하고 로그인 사용자를 메인 페이지로 이동시킵니다.
export default function PublicOnlyGuard({ children }: PublicOnlyGuardProps) {
  ...
  useEffect(() => {
    ...
    // 현재 브라우저 인증 세션을 확인하고 공개 페이지 표시 가능 여부를 갱신합니다.
  ...
  if (isCheckingSession || !canViewPublicPage) {
    return (
